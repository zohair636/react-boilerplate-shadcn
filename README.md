...
Most projects collapse because they group files by **technical type** (all hooks together, all components together). This boilerplate enforces **Feature-Based Architecture**.
